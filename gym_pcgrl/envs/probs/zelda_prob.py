...
start from random and generate 
    - 
    - increase the dataset
    - run training data on inference 
    - and generate new traj similar to training data and run this on inference
...
class ZeldaProblem(Problem):
    ...
    def get_reward(self, new_stats, old_stats):
        ...
        rewards = {
            ...
            "enemies": get_range_reward(new_stats["enemies"], old_stats["enemies"], 0, self._max_enemies),
